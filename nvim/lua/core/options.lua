...
local dir_undo = vim.fn.stdpath("state") .. "/" .. "undo"
if vim.fn.isdirectory(dir_undo) == 0 then
    vim.fn.mkdir(dir_undo, "p", '0o755')
end
vim.g.undolevels = 10000 -- maximum number of changes that can be undone
